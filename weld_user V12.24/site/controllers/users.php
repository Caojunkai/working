 ...
 * @since  1.6
 */
class WeldUsersControllerUsers extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'User', $prefix = 'WeldUsersModel', $config = array('ignore_request' => true))
	{
	...
	public function changeBlock()
	{
		...
		$this->setRedirect('index.php?option=com_weldusers&view=users');
	}
