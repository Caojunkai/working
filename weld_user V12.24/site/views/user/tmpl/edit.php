...
<form action="<?php echo JRoute::_('index.php?option=com_weldusers&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="user-form" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<a href="index.php?option=com_weldusers&view=users">	<button type="button" class="btn"><span class="icon-cancel"></span>取消</button></a>
			</div>
