...
<form action="<?php echo JRoute::_('index.php?option=com_resource&view=gases'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="control-group">
		<div class="controls">
			<a href="<?php echo JRoute::_('index.php?option=com_resource&view=gas&layout=edit', false);?>"><button type="button" class=" btn btn-small btn-success"><span class="icon-new icon-white"></span>新建</button></a>
	...
	<input type="hidden" name="resource" value="gas" />
