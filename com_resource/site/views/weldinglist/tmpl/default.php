...
<form action="index.php?option=com_resource&view=weldinglist" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
			<h3>焊丝管理列表</h3>
			<?php
	...
	<input type="hidden" name="task" value="welding.manage">
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th width="30%">
				<?php echo JHtml::_('grid.sort', '直径', 'diameter', $listDirn, $listOrder); ?>
			</th>
			<th width="20%">
		...
		<?php if (!empty($this->items)) : ?>
			<?php foreach ($this->items as $i => $row) :
				$link = JRoute::_('index.php?option=com_resource&view=welding&id=' . $row->id);
				?>
				<tr>
					<td>
