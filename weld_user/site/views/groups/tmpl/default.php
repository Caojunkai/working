...
?>
<form action="<?php echo JRoute::_('index.php?option=com_weldusers&view=groups');?>" method="post" name="adminForm" id="adminForm">
	<div class="control-group">
		<div class="controls">
	<a href="<?php echo JRoute::_('index.php?option=com_weldusers&view=group&layout=edit', false);?>"><button type="button" class=" btn btn-small btn-success"><span class="icon-new icon-white"></span>新建</button></a>
...
<?php endif;?>
				...
				?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							...
							<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_weldusers&task=group.edit&id=' . $item->id);?>">
								<?php echo $this->escape($item->title); ?></a>
							<?php else : ?>
								<?php echo $this->escape($item->title); ?>
							<?php endif; ?>
							<?php if (JDEBUG) : ?>
								<div class="small"><a href="<?php echo JRoute::_('index.php?option=com_weldusers&view=debuggroup&group_id=' . (int) $item->id);?>">
		...
		<input type="hidden" name="edt" value="group">
