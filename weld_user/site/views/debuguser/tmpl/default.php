...
?>
<form action="<?php echo JRoute::_('index.php?option=com_weldusers&view=debuguser&user_id=' . (int) $this->state->get('filter.user_id'));?>" method="post" name="adminForm" id="adminForm">
