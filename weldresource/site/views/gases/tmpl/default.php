...
<form action="<?php echo JRoute::_('index.php?option=com_weldresource&view=gases'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="control-group">
		<div class="controls">
			<a href="<?php echo JRoute::_('index.php?option=com_weldresource&view=gas&layout=edit', false);?>"><button type="button" class=" btn btn-small btn-success"><span class="icon-new icon-white"></span>新建</button></a>
		...
		<table class="table table-striped" id="articleList">
			...
			<?php foreach ($this->items as $i => $item) :?>
				<tr class="row<?php echo $i % 2; ?>" >
					...
					<td class="center">
						<a href="<?php echo JRoute::_('index.php?option=com_weldresource&view=gas&layout=edit&id='.(int) $item->id);?>"><?php echo $this->escape($item->name); ?></a>
					</td>
					...
					<td class="hidden-phone">
						<?php echo $this->escape($item->standard); ?>
					</td>
	...
	<input type="hidden" name="weldresource" value="gas" />
