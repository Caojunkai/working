 ...
 * @since       0.0.9
 */
class WeldResourceControllerWeldResource extends JControllerForm
{
	/**
	 * Constructor.
	 *
	...
	{
		$name = empty($name) ? $this->view_item :  $name;
		return parent::getModel($name, 'WeldResourceModel', $config);
