...
CREATE TABLE IF NOT EXISTS `#__weldresource_welder` (
...
CREATE TABLE IF NOT EXISTS `#__weldresource_gas`(
...
CREATE TABLE IF NOT EXISTS `#__weldresource_welding`(
...
CREATE TABLE IF NOT EXISTS `#__weldresource_tech` (
  `id`INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__weldresource_workshop` (
...
CREATE TABLE IF NOT EXISTS `#__weldresource_machine` (
...
CREATE TABLE IF NOT EXISTS `#__weldresource_maintain` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
