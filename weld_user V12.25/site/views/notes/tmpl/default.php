...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_weldusers&view=notes');?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped">
			...
			<?php foreach ($this->items as $i => $item) : ?>
				<?php $canChange = $user->authorise('core.edit.state', 'com_weldusers'); ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						...
						<?php endif; ?>
						<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_weldusers&task=note.edit&id=' . $item->id);?>">
					...
					<td>
						<?php if ($item->catid && $item->cparams->get('image')) : ?>
							<?php echo JHtml::_('weldusers.image', $item->cparams->get('image')); ?>
						<?php endif; ?>
