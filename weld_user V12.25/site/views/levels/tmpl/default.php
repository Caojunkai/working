...
$canOrder   = $user->authorise('core.edit.state', 'com_weldusers');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_weldusers&task=levels.saveOrderAjax&tmpl=component';
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_weldusers&view=levels');?>" method="post" id="adminForm" name="adminForm">
	<div class="control-group">
		<div class="controls">
			<a href="<?php echo JRoute::_('index.php?option=com_weldusers&view=level&layout=edit', false);?>"><button type="button" class=" btn btn-small btn-success"><span class="icon-new icon-white"></span>新建</button></a>
...
<?php endif;?>
		...
		<?php else : ?>
			<table class="table table-striped" id="levelList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate = $user->authorise('core.create',     'com_weldusers');
					$canEdit   = $user->authorise('core.edit',       'com_weldusers');
					$canChange = $user->authorise('core.edit.state', 'com_weldusers');
					?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_weldusers&task=level.edit&id=' . $item->id);?>">
		...
		<input type="hidden" name="sub" value="levels" />
		<input type="hidden" name="edt" value="level">
